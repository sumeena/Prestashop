...
{if !$opc}<h1>{l s='Choose your payment method'}</h1>{else}<h1>3 - {l s='Choose your payment method'}</h1>{/if}
		...
		<form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
			<fieldset>
				...
				<div class="voucher_box">
					<p><input type="text" id="discount_name" name="discount_name" value="{if isset($discount_name) && $discount_name}{$discount_name}{/if}" /></p>
