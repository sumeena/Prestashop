...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{$lang_iso}">
    <head>
        ...
        {if isset($css_files)}
            ...
            {/foreach}
        {/if}
        <link href="{$css_dir}tptnResponsive.css" rel="stylesheet" type="text/css" media="{$media}" />
        {if isset($js_files)}
                ...
                <div id="page">
                    ...
                    <div id="header">
                        <div id="header_right" class="row">
                            <div class="logo_sec"><a id="header_logo" href="{$base_dir}" title="{$shop_name|escape:'htmlall':'UTF-8'}">Cinthe<strong>.com</strong></a></div>

                            </a>
                            <div id="top-categ">
                                <span>{l s='' mod='tptntoplinks'}</span>
                            </div>
