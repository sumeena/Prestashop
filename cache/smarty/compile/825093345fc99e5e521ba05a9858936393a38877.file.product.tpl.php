<?php /* Smarty version Smarty-3.1.8, created on 2013-08-06 01:47:53
         compiled from "C:\xampp\htdocs\prestashop\themes\leo_tshirt\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2972652008e09457cf2-10966333%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '825093345fc99e5e521ba05a9858936393a38877' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\themes\\leo_tshirt\\product.tpl',
      1 => 1352085906,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2972652008e09457cf2-10966333',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52008e09eaa570_59241656',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52008e09eaa570_59241656')) {function content_52008e09eaa570_59241656($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
...
<?php }?>
			...
			<li><span class="span_link" id="view_full_size"><?php echo smartyTranslate(array('s'=>'View full size'),$_smarty_tpl);?>
</span></li>
...
<?php }?>
					<?php }?>-->
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage'){?><span id="reduction_percent_display"><?php echo smartyTranslate(array('s'=>'('),$_smarty_tpl);?>
 -<?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']*100;?>
%<?php echo smartyTranslate(array('s'=>')'),$_smarty_tpl);?>
</span><?php }?>
				<span id="reduction_amount_display"><?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='amount'&&intval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])!=0){?><?php echo smartyTranslate(array('s'=>'( -'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])),$_smarty_tpl);?>
<?php echo smartyTranslate(array('s'=>')'),$_smarty_tpl);?>
<?php }?></span>
