...
class BlockAboutusfooter extends Module
{
    public function __construct()
    {
        $this->name = 'blockaboutusfooter';
		...
		$this->displayName = $this->l('Megashop Footer Aboutus block');
        $this->description = $this->l('Displays a block in the footer');
    }
...
////		));
//		return $this->display(__FILE__, 'blockaboutusfooter.tpl');
//	}
